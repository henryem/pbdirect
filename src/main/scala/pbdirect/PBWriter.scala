...
trait PBWriter[A] {
  ...
  def writtenBytesSize(index: Int, value: A, sizes: SizeMap): Int = {
    if (sizes.containsKey(value)) {
      ...
      val size = prememoizedWrittenBytesSize(index, value, sizes)
      sizes.put(value, size)
      size
    }
  }
  protected def prememoizedWrittenBytesSize(index: Int, value: A, sizes: SizeMap): Int = throw new NotImplementedError("unmemoizedWrittenBytesSize")
}
...
trait LowPriorityPBWriterImplicits {
  def fixedSizeInstance[A](size: Int)(f: (Int, A, CodedOutputStream, SizeMap) => Unit): PBWriter[A] =
    new PBWriter[A] {
      override def writeTo(index: Int, value: A, out: CodedOutputStream, sizes: SizeMap): Unit = f(index, value, out, sizes)
      override def writtenBytesSize(index: Int, value: A, sizes: java.util.Map[Any, Int]): Int = size
    }
  
  def unmemoizedInstance[A](serialize: (Int, A, CodedOutputStream, SizeMap) => Unit, computeBytesSize: (Int, A, SizeMap) => Int): PBWriter[A] =
    new PBWriter[A] {
  ...
  def memoizedInstance[A](serialize: (Int, A, CodedOutputStream, SizeMap) => Unit, computeBytesSize: (Int, A, SizeMap) => Int): PBWriter[A] =
    new PBWriter[A] {
      override def writeTo(index: Int, value: A, out: CodedOutputStream, sizes: SizeMap): Unit = serialize(index, value, out, sizes)
      override def prememoizedWrittenBytesSize(index: Int, value: A, sizes: SizeMap): Int = computeBytesSize(index, value, sizes)
    }
  
  implicit val hnilWriter: PBWriter[HNil] = fixedSizeInstance(0) {
  ...
  implicit val cnilWriter: PBWriter[CNil] = fixedSizeInstance(0){
...
trait PBWriterImplicits extends LowPriorityPBWriterImplicits {
  implicit object BooleanWriter extends PBWriter[Boolean] {
    ...
    override def writtenBytesSize(index: Int, value: Boolean, sizes: SizeMap): Int = CodedOutputStream.computeBoolSize(index, value)
  }
  implicit object ByteWriter extends PBWriter[Byte] {
    ...
    override def writtenBytesSize(index: Int, value: Byte, sizes: SizeMap): Int = CodedOutputStream.computeInt32Size(index, value)
  }
  implicit object ShortWriter extends PBWriter[Short] {
    override def writeTo(index: Int, value: Short, out: CodedOutputStream, sizes: SizeMap): Unit =
      out.writeInt32(index, value)
    override def writtenBytesSize(index: Int, value: Short, sizes: SizeMap): Int = CodedOutputStream.computeInt32Size(index, value)
  }
  implicit object IntWriter extends PBWriter[Int] {
    override def writeTo(index: Int, value: Int, out: CodedOutputStream, sizes: SizeMap): Unit =
      out.writeInt32(index, value)
    override def writtenBytesSize(index: Int, value: Int, sizes: SizeMap): Int = CodedOutputStream.computeInt32Size(index, value)
  }
  implicit object LongWriter extends PBWriter[Long] {
    ...
    override def writtenBytesSize(index: Int, value: Long, sizes: SizeMap): Int = CodedOutputStream.computeInt64Size(index, value)
  }
  implicit object FloatWriter extends PBWriter[Float] {
    ...
    override def writtenBytesSize(index: Int, value: Float, sizes: SizeMap): Int = CodedOutputStream.computeFloatSize(index, value)
  }
  implicit object DoubleWriter extends PBWriter[Double] {
    ...
    override def writtenBytesSize(index: Int, value: Double, sizes: SizeMap): Int = CodedOutputStream.computeDoubleSize(index, value)
  }
  implicit object StringWriter extends PBWriter[String] {
    ...
    override def prememoizedWrittenBytesSize(index: Int, value: String, sizes: SizeMap): Int = {
      // This is potentially an expensive operation, so we want to memoize it.
  ...
  implicit object BytesWriter extends PBWriter[Array[Byte]] {
    ...
    override def writtenBytesSize(index: Int, value: Array[Byte], sizes: SizeMap): Int = CodedOutputStream.computeByteArraySize(index, value)
  }
  implicit def functorWriter[F[_], A](implicit functor: Functor[F], writer: PBWriter[A]): PBWriter[F[A]] =
    memoizedInstance(
      ...
      { (index: Int, value: F[A], sizes: SizeMap) =>
        //FIXME: Recomputes the mapping, and may not work for arbitrary functors.
        var total = 0
